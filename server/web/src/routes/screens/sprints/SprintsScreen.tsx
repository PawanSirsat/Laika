...
/**
 * Sprints (LAI-082 registers it; Builder-A builds it — D-028).
 *
 ...
 * Builder-B's. Everything inside `routes/screens/sprints/` is Builder-A's.
 *
...
export function SprintsScreen() {
  return <LoadingState shape="row" count={4} label="Loading sprints" />;
}
