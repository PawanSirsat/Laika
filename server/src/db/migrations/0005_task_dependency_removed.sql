...
-- Appended by hand after generation (LAI-011). Third time: any `activity` change
-- is a table rebuild, and SQLite drops a table's triggers with the table. Without
-- this the append-only guarantee of SPEC §4.8 disappears silently.
